...
public class Game5 : MonoBehaviour {
    ...
    private Button_UI Button5;

    private void Awake() {
        Application.runInBackground = false;
        Application.targetFrameRate = 100;

        Button5 = transform.Find("Btn5").GetComponent<Button_UI>();
        Button5.ClickFunc = () => {
            // Launch Game!
            string path = Application.dataPath + "/../Builds/Students/john/Wildgoose_John_XR_Assign1/Wildgoose_John_XR_Assign1_Win64-bit/XR Assignment 1.exe";
            process = Process.Start(path);
            ShowProcessLaunchedMessage("Launching Escape the Abandoned City...");
        };
